...
public class CmdAcceptSuggest extends Command {

    public CmdAcceptSuggest() {
        this.name = "AcceptSuggest";
        this.aliases = new String[] {"asuggest"};
        this.help = "Cancel a suggestion";
    ...
    protected void execute(CommandEvent event) {
        ...
        event.getChannel().retrieveMessageById(args[1]).queue(message -> {
            ...
            Embed.setColor(Color.decode("#32CD32"));
