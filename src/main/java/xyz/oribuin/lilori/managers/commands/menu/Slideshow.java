...
public class Slideshow extends xyz.oribuin.lilori.managers.commands.menu.Menu {
    ...
    public static class Builder extends Menu.Builder<Builder, Slideshow> {
        ...
        public Builder addUrl(String item) {
            strings.add(item);
            return this;
        }

        public Builder addUrls(String... items) {
            strings.addAll(Arrays.asList(items));
            return this;
        }

        public Builder addUrls(List<String> items) {
            strings.addAll(items);
            return this;
        }

        public Builder setUrl(String item) {
            strings.clear();
            strings.add(item);
            return this;
        }
